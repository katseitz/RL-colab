...
expName = 'RL_out-of-scanner'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/akashrathi/Documents/GithubClones/RL-colab/RL_out-of-scanner_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if expInfo["handedness"] == "right":
        left_button = 'j' #vars must be in single quotes
        ...
        pointer = left_button
        left_prac_text = "Practice selecting the left box by pressing with your pointer finger (j key)."
        right_prac_text = "Practice selecting the right box by pressing with your middle finger (k key)."
    #define left and right button for right handed people
    else:
        left_button = 'd'
        prac_left_button = left_button
        ...
        left_prac_text = "Practice selecting the left box by pressing with your middle finger (d key)."
        right_prac_text = "Practice selecting the right box by pressing with your pointer finger (f key)."
    ...
    scanner_text = visual.TextStim(win=win, name='scanner_text',
        text='Please press the space bar with your free hand to start the task.',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisRun in runs:
        ...
        while continueRoutine:
            ...
            if trigger_value.status == STARTED and not waitOnFlip:
                theseKeys = trigger_value.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
