...
function summary_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    summary_instructionsComponents.forEach( function(thisComponent) {
...
function scanner_triggerRoutineBegin(snapshot) {
  return async function () {
    ...
    scanner_triggerComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cue_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    cue_responseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function run_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    run_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function leftover_time_breakRoutineBegin(snapshot) {
  return async function () {
    ...
    leftover_time_breakComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
